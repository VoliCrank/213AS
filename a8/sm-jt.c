...
int exec() {
  int cont = 1;
  int addr, val;
  static const void* jt[16]= {&&L0, &&L1, &&L2, &&L3, &&L4, &&DEFAULT, &&L6, &&L7, &&L8, &&L9, &&L10, &&L11, &&L12, &&DEFAULT, &&DEFAULT, &&L15};
  static const void* jtI[16]={&&D0, &&D1, &&D2, &&D3,&&D4, &&D5, &&D6,&&D7, &&DEFAULT1, &&DEFAULT1, &&DEFAULT1, &&DEFAULT1, &&DEFAULT1, &&DEFAULT1, &&DEFAULT1,&&D15};
  ...
  L6: // ALU ................... 6-sd
    ...
    //switch (insOp0) {
  if (insOp0 < 0 || insOp0 > 0xf) goto DEFAULT1;
  goto *jtI[insOp0];
          D0: // mov rs, rd ........ 60sd
